...
public  class ListExperienceBase extends AnchorPane {
    ...
    public ListExperienceBase(int exper,String titreforma,String instit,String datedebut,String datefin,String descriform) {
       id_exp=exper;
        ...
        image_profile.setImage(new Image(getClass().getResource("/com/thinklance/pidev/ressourses/Corporation.png").toExternalForm()));
